...
| [hilt-model-guide.md](hilt-model-guide.md) | **For saber designers.** Preparing a hilt model for the demo room from Fusion, SOLIDWORKS, Onshape and Shapr3D (GLB preferred, OBJ + MTL fallback), checking the fit, what to send, and how packs protect the model |
